...
var appUp = angular.module('fileUpload', ['ngFileUpload']);
var version = '7.0.16';

appUp.controller('NewCtrl', ['$scope', '$http', '$timeout', '$compile', 'Upload', function ($scope, $http, $timeout, $compile, Upload) {
  ...
  function uploadUsingUpload(file) {
    file.upload = Upload.upload({
      url: 'https://localhost/upload/' + $scope.getReqParams(),
      method: 'POST',
      headers: {
